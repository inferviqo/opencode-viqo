...
Use this folder for locale-specific translation guidance that supplements `.viqo/agent/translator.md`.
...
- PR #12345: https://github.com/Inferviqo/viqo/pull/12345

## Do Not Translate (Locale Additions)

- `Viqo` (preserve casing)
