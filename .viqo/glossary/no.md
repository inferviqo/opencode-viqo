...
- PR #10018: https://github.com/Inferviqo/viqo/pull/10018
- PR #12935: https://github.com/Inferviqo/viqo/pull/12935

## Do Not Translate (Locale Additions)

- `Viqo` (preserve casing in prose; keep `viqo` only in commands, package names, paths, or code)
- `Viqo CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
