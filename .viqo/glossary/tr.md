...
- PR #15835: https://github.com/Inferviqo/viqo/pull/15835

## Do Not Translate (Locale Additions)

- `Viqo` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `viqo` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Viqo` in prose, `viqo` only for exact technical identifiers
...
- Avoid changing `viqo` to `Viqo` inside commands, URLs, package names, or code literals
