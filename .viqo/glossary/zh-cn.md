...
- PR #13942: https://github.com/Inferviqo/viqo/pull/13942

## Do Not Translate (Locale Additions)

- `Viqo` (preserve casing in prose; keep `viqo` only when it is part of commands, package names, paths, or code)
- `Viqo Zen`
- `Viqo CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `viqo` in prose when referring to the product name; use `Viqo`
