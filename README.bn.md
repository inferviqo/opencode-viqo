...
# Package managers
npm i -g viqo-ai@latest        # or bun/pnpm/yarn
scoop install viqo             # Windows
choco install viqo             # Windows
brew install Inferviqo/tap/viqo # macOS and Linux (recommended, always up to date)
brew install viqo              # macOS and Linux (official brew formula, updated less)
sudo pacman -S viqo            # Arch Linux (Stable)
paru -S viqo-bin               # Arch Linux (Latest from AUR)
mise use -g viqo               # Any OS
nix run nixpkgs#viqo           # or github:Inferviqo/viqo for latest dev branch
```
...
Viqo ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/Inferviqo/viqo/releases) অথবা [inferviqo.com/download](https://inferviqo.com/download) থেকে ডাউনলোড করুন।
...
1. `$VIQO_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.viqo/bin` - ডিফল্ট ফলব্যাক
...
Viqo এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://inferviqo.com/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে Viqo কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://inferviqo.com/docs)।

### অবদান (Contributing)

আপনি যদি Viqo এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Viqo এর উপর বিল্ডিং (Building on Viqo)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Viqo এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "viqo" ব্যবহার করেন, উদাহরণস্বরূপ "viqo-dashboard" বা "viqo-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Viqo দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/viqo) | [X.com](https://x.com/viqo)
