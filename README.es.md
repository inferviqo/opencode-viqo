...
npm i -g viqo-ai@latest        # o bun/pnpm/yarn
scoop install viqo             # Windows
choco install viqo             # Windows
brew install Inferviqo/tap/viqo # macOS y Linux (recomendado, siempre al día)
brew install viqo              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S viqo            # Arch Linux (Stable)
paru -S viqo-bin               # Arch Linux (Latest from AUR)
mise use -g viqo               # cualquier sistema
nix run nixpkgs#viqo           # o github:Inferviqo/viqo para la rama dev más reciente
```
...
Viqo también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/Inferviqo/viqo/releases) o desde [inferviqo.com/download](https://inferviqo.com/download).
...
1. `$VIQO_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.viqo/bin` - Alternativa por defecto
...
Viqo incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://inferviqo.com/docs/agents).

### Documentación

Para más información sobre cómo configurar Viqo, [**ve a nuestra documentación**](https://inferviqo.com/docs).

### Contribuir

Si te interesa contribuir a Viqo, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Viqo

Si estás trabajando en un proyecto basado en Viqo y usas "viqo" como parte del nombre, por ejemplo, "viqo-dashboard" u "viqo-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Viqo y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/viqo) | [X.com](https://x.com/viqo)
