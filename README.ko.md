...
# 패키지 매니저
npm i -g viqo-ai@latest        # bun/pnpm/yarn 도 가능
scoop install viqo             # Windows
choco install viqo             # Windows
brew install Inferviqo/tap/viqo # macOS 및 Linux (권장, 항상 최신)
brew install viqo              # macOS 및 Linux (공식 brew formula, 업데이트 빈도 낮음)
sudo pacman -S viqo            # Arch Linux (Stable)
paru -S viqo-bin               # Arch Linux (Latest from AUR)
mise use -g viqo               # 어떤 OS든
nix run nixpkgs#viqo           # 또는 github:Inferviqo/viqo 로 최신 dev 브랜치
```
...
Viqo 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/Inferviqo/viqo/releases) 에서 직접 다운로드하거나 [inferviqo.com/download](https://inferviqo.com/download) 를 이용하세요.
...
Viqo 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://inferviqo.com/docs/agents) 에 대해 더 알아보세요.

### 문서

Viqo 설정에 대한 자세한 내용은 [**문서**](https://inferviqo.com/docs) 를 참고하세요.

### 기여하기

Viqo 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### Viqo 기반으로 만들기

Viqo 와 관련된 프로젝트를 진행하면서 이름에 "viqo"(예: "viqo-dashboard" 또는 "viqo-mobile") 를 포함한다면, README 에 해당 프로젝트가 Viqo 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/viqo) | [X.com](https://x.com/viqo)
