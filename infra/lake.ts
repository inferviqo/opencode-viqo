...
const tableBucketName = `viqo-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `viqo-${$app.stage}-lake-ingest`,
    destination: "iceberg",
