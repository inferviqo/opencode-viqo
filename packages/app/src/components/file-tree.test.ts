...
beforeAll(async () => {
  ...
  mock.module("@viqo-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@viqo-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@viqo-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@viqo-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
