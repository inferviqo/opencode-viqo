...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: ViqoClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: ViqoClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ViqoClient) =>
  queryOptions({
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, ViqoClient>()
