export const dict = {
  ...
  "dialog.provider.viqo.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.viqo.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.viqoGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Viqo",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Viqo.",
  ...
  "provider.connect.viqoZen.line1":
    "Viqo Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.viqoZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.viqoZen.visit.prefix": "Visite ",
  "provider.connect.viqoZen.visit.link": "inferviqo.com/zen",
  "provider.connect.viqoZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Viqo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Viqo.",
  ...
  "dialog.plugins.empty": "Plugins configurados em viqo.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Viqo este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Viqo ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Viqo",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (viqo.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Viqo ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Viqo inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Viqo dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Viqo",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Viqo aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Viqo segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Viqo é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Viqo iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Viqo.",
