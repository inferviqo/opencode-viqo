export const dict = {
  ...
  "dialog.provider.viqo.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.viqo.tagline": "Reliable optimized models",
  "dialog.provider.viqoGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Viqo",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Viqo.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.viqoZen.line1":
    "Viqo Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.viqoZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.viqoZen.visit.prefix": "Visit ",
  "provider.connect.viqoZen.visit.link": "inferviqo.com/zen",
  "provider.connect.viqoZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Viqo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Viqo.",
  ...
  "dialog.plugins.empty": "Plugins configured in viqo.json",
  ...
  "dialog.server.description": "Switch which Viqo server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Viqo...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Viqo in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Viqo...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Viqo in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Viqo in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Viqo",
  "wsl.onboarding.viqoReadyIn": "Viqo is ready in {{distro}}.",
  "wsl.onboarding.viqoReady": "Viqo is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Viqo in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Viqo",
  ...
  "wsl.onboarding.distroStatus.viqoMissing": "Viqo not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Viqo can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Viqo could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Viqo.",
  ...
  "toast.update.description": "A new version of Viqo ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Viqo team",
  ...
  "error.chain.checkConfig": "Check your config (viqo.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Viqo does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Viqo includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Viqo server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Viqo",
  ...
  "settings.general.row.appearance.description": "Customise how Viqo looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Viqo follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Viqo is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Viqo launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Viqo.",
