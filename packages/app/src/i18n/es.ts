export const dict = {
  ...
  "dialog.provider.viqo.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.viqo.tagline": "Modelos optimizados y fiables",
  "dialog.provider.viqoGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Viqo",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Viqo.",
  ...
  "provider.connect.viqoZen.line1":
    "Viqo Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.viqoZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.viqoZen.visit.prefix": "Visita ",
  "provider.connect.viqoZen.visit.link": "inferviqo.com/zen",
  "provider.connect.viqoZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Viqo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Viqo.",
  ...
  "dialog.plugins.empty": "Plugins configurados en viqo.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Viqo se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Viqo ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Viqo",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (viqo.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Viqo no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Viqo incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Viqo dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Viqo",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Viqo en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Viqo sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Viqo.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Viqo",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Viqo.",
