...
export const dict = {
  ...
  "dialog.provider.viqo.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.viqo.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.viqoGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Viqo",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Viqo.",
  ...
  "provider.connect.viqoZen.line1":
    "Viqo Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.viqoZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.viqoZen.visit.prefix": "Besøk ",
  "provider.connect.viqoZen.visit.link": "inferviqo.com/zen",
  "provider.connect.viqoZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Viqo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Viqo.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i viqo.json",
  ...
  "dialog.server.description": "Bytt hvilken Viqo-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Viqo ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Viqo-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (viqo.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Viqo ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Viqo inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Viqo-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Viqo",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Viqo ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Viqo skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Viqo er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Viqo starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Viqo.",
