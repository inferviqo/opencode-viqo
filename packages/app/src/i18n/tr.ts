...
export const dict = {
  ...
  "dialog.provider.viqo.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.viqo.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.viqoGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Viqo tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Viqo'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.viqoZen.line1":
    "Viqo Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.viqoZen.visit.prefix": "",
  "provider.connect.viqoZen.visit.link": "inferviqo.com/zen",
  "provider.connect.viqoZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Viqo'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Viqo'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler viqo.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Viqo sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Viqo'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Viqo ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (viqo.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Viqo henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Viqo ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Viqo Masaüstü",
  ...
  "settings.desktop.wsl.description": "Viqo sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Viqo'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Viqo'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Viqo'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Viqo'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Viqo başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Viqo'un en son sürümünü kullanıyorsunuz.",
