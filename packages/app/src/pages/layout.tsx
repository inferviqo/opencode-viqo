...
import { Session } from "@viqo-ai/sdk/v2/client"
...
import { toaster } from "@viqo-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@viqo-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://inferviqo.com/desktop-feedback")}
      renderPanel={() =>
