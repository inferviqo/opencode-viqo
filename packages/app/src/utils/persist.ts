...
const GLOBAL_STORAGE = "viqo.global.dat"
const WINDOW_STORAGE = "viqo.window"
const LOCAL_PREFIX = "viqo."
...
function workspaceStorage(dir: string) {
  ...
  return `viqo.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `viqo.draft.${head}.${sum}.dat`
}
