...
import { compile, emitEffectImported, emitPromise, write } from "@viqo-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "ViqoEventEncoded",
              import: 'import type { ViqoEventEncoded } from "@viqo-ai/protocol/groups/event"',
            },
          },
        }),
