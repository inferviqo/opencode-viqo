...
import desktopAppIcon from "../../asset/lander/viqo-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://inferviqo.com/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>inferviqo.com/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g viqo-ai")}>
                <code>
                  npm i -g <strong>viqo-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g viqo-ai")}>
                <code>
                  bun add -g <strong>viqo-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install Inferviqo/tap/viqo")}>
                <code>
                  brew install <strong>Inferviqo/tap/viqo</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S viqo")}>
                <code>
                  paru -S <strong>viqo</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask viqo-desktop")}>
                <code>
                  brew install --cask <strong>viqo-desktop</strong>
                </code>
                <CopyStatus />
              </button>
