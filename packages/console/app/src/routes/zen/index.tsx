...
import compareVideo from "../../asset/lander/viqo-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/viqo-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="viqo:auth" content={loggedin() ? "true" : "false"} />
