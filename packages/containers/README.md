...
```
REGISTRY=ghcr.io/Inferviqo TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/Inferviqo TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/Inferviqo/build/bun-node:24.04
```
