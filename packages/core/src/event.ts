...
import type { Data, Definition, Payload } from "@viqo-ai/schema/event"
...
import { Durable } from "@viqo-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@viqo-ai/schema/event").ID
export type { Data, Definition, Payload } from "@viqo-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/Event") {}
