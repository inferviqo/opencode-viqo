...
import { Entry, FileSystem, FindInput, Match } from "@viqo-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@viqo-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/v2/FileSystem") {}
