...
export class Service extends Context.Service<Service, Interface>()("@viqo/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.VIQO_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
