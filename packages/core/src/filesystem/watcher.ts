...
import { FileSystemWatcher } from "@viqo-ai/schema/filesystem-watcher"
...
declare const VIQO_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof VIQO_LIBC === "undefined" ? undefined : VIQO_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@viqo/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.VIQO_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.VIQO_EXPERIMENTAL_FILEWATCHER) {
