...
import type { EffectDrizzleSqlite } from "@viqo-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/ProjectDirectories") {}
