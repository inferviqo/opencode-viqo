...
import { define } from "@viqo-ai/plugin/v2/effect"
...
import { LocationServiceMap } from "@viqo-ai/core/location-services"
      ...
      Effect.flatMap(([blocked, allowed]) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(() =>
            fs.writeFile(
              path.join(blocked.path, "viqo.json"),
              JSON.stringify({
