...
import { ModelV2 } from "@viqo-ai/core/model"
import { SessionV2 } from "@viqo-ai/core/session"
import { Agent } from "@viqo-ai/schema/agent"
import { Location } from "@viqo-ai/schema/location"
import { Model } from "@viqo-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@viqo-ai/schema/prompt"
import { Provider } from "@viqo-ai/schema/provider"
import { Project } from "@viqo-ai/schema/project"
import { ProjectDirectories } from "@viqo-ai/schema/project-directories"
import { PermissionV1 } from "@viqo-ai/schema/permission-v1"
import { Session } from "@viqo-ai/schema/session"
import { SessionInput } from "@viqo-ai/schema/session-input"
import { SessionMessage } from "@viqo-ai/schema/session-message"
import { Workspace } from "@viqo-ai/schema/workspace"
import { Command } from "@viqo-ai/schema/command"
import { Connection } from "@viqo-ai/schema/connection"
import { Credential } from "@viqo-ai/schema/credential"
import { FileSystem } from "@viqo-ai/schema/filesystem"
import { Integration } from "@viqo-ai/schema/integration"
import { LLM } from "@viqo-ai/schema/llm"
import { Permission } from "@viqo-ai/schema/permission"
import { Plugin } from "@viqo-ai/schema/plugin"
import { Pty } from "@viqo-ai/schema/pty"
import { Reference } from "@viqo-ai/schema/reference"
import { SessionTodo } from "@viqo-ai/schema/session-todo"
import { Skill } from "@viqo-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@viqo-ai/schema/schema"
import { ProviderV2 } from "@viqo-ai/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@viqo-ai/core/command"),
    import("@viqo-ai/core/integration/connection"),
    import("@viqo-ai/core/credential"),
    import("@viqo-ai/core/filesystem"),
    import("@viqo-ai/core/integration"),
    import("@viqo-ai/core/location"),
    import("@viqo-ai/llm"),
    import("@viqo-ai/core/permission"),
    import("@viqo-ai/core/v1/permission"),
    import("@viqo-ai/core/project/copy"),
    import("@viqo-ai/core/pty"),
    import("@viqo-ai/core/project/schema"),
    import("@viqo-ai/core/reference"),
    import("@viqo-ai/core/session/input"),
    import("@viqo-ai/core/session/message"),
    import("@viqo-ai/core/session/todo"),
    import("@viqo-ai/core/session/prompt"),
    import("@viqo-ai/core/skill"),
    import("@viqo-ai/core/v2-schema"),
    import("@viqo-ai/core/schema"),
    import("@viqo-ai/core/workspace"),
  ])
