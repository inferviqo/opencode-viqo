...
const releaseId = process.env.VIQO_RELEASE
if (!releaseId) throw new Error("VIQO_RELEASE is required")

const version = process.env.VIQO_VERSION
if (!version) throw new Error("VIQO_VERSION is required")
...
const macxTarGz = "viqo-desktop-mac-x64.app.tar.gz"
const macaTarGz = "viqo-desktop-mac-arm64.app.tar.gz"
