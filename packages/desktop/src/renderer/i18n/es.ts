export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Viqo",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Viqo. ¿Quieres instalarla y reiniciar?",
