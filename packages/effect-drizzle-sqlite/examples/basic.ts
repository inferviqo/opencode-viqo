...
class Database extends Context.Service<Database, DatabaseShape>()("@viqo/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@viqo/example/UserStore") {
