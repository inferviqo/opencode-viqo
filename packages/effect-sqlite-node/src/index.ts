...
export const TypeId: TypeId = "~@viqo-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@viqo-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@viqo-ai/effect-sqlite-node/NodeSqliteClient")
