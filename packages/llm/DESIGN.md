...
> current private `@viqo-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@viqo-ai/ai`
...
- Secondary audience: Viqo and other durable agent runtimes
...
import { LLM } from "@viqo-ai/ai"
import { OpenAI } from "@viqo-ai/ai/providers/openai"
...
```ts
import { Message } from "@viqo-ai/ai"
...
import { LLM, Tool } from "@viqo-ai/ai"
...
Viqo and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@viqo-ai/ai/promise"
import { OpenAI } from "@viqo-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@viqo-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@viqo-ai/ai/provider"
...
@viqo-ai/ai/providers/openai
@viqo-ai/ai/providers/anthropic
@viqo-ai/ai/providers/google
...
```
...
Viqo should migrate to `generateTurn` / `streamTurn`, preserving its durable
