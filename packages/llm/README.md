...
Schema-first LLM core for viqo. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@viqo-ai/llm"
import { OpenAI } from "@viqo-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@viqo-ai/llm/providers"
