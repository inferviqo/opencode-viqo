...
- Effect plugins import `@viqo-ai/plugin/v2/effect`, not `@viqo-ai/core`.
- Public domain values use generated `@viqo-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@viqo-ai/plugin/v2/effect`.
