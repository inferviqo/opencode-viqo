...
import { EventManifest } from "@viqo-ai/schema/event-manifest"
import { Location } from "@viqo-ai/schema/location"
import type { Definition } from "@viqo-ai/schema/event"
...
export const ViqoEvent = event.schema
export type ViqoEvent = typeof ViqoEvent.Type
export type ViqoEventEncoded = typeof ViqoEvent.Encoded
