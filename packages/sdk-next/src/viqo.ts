import { Viqo } from "@viqo-ai/client/effect"
...
import { createEmbeddedRoutes } from "@viqo-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Viqo.create")(function* () {
  ...
  const client = yield* Viqo.make({ baseUrl: "http://viqo.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@viqo-ai/sdk-next/Viqo") {}
