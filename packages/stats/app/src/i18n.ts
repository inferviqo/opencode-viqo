...
const en = {
  "app.title": "AI Model Usage Rankings | Viqo Data",
  "app.description":
    "Explore Viqo Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Viqo Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Viqo on GitHub",
  "header.github": "GitHub",
  "header.tryViqo": "Try Viqo",
  ...
  "home.topModelsDescription": "Usage of models across Viqo Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Viqo Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Viqo Data",
  "lab.description":
    "Compare {{lab}} models used in Viqo Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Viqo usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Viqo",
  ...
  "lab.shareOfUsage": "{{share}} of recent Viqo usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Viqo Data",
  "model.description":
    "View {{model}} Viqo Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Viqo Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Viqo Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Viqo Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Viqo Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Viqo Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily Viqo Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique Viqo Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average Viqo Go session shape.",
  ...
  "model.geoDescription": "Viqo Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Viqo Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Viqo Go token volume.",
