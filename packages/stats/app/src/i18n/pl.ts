export const dict = {
  "app.title": "Rankingi użycia modeli AI | Viqo Data",
  "app.description":
    "Przeglądaj użycie Viqo Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Viqo Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Viqo na GitHub",
  "header.github": "GitHub",
  "header.tryViqo": "Wypróbuj Viqo",
  ...
  "footer.homeAria": "Strona główna Viqo",
  ...
  "home.topModelsDescription": "Użycie modeli w Viqo Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Viqo Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Viqo Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Viqo Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Viqo.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Viqo",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Viqo",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Viqo z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Viqo Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Viqo Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Viqo Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Viqo Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Viqo Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Viqo Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Viqo Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Viqo Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Viqo Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Viqo Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Viqo Go.",
  ...
  "model.geoDescription": "Tokeny modelu Viqo Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Viqo Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Viqo Go.",
