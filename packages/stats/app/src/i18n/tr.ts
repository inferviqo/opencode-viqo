export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Viqo Data",
  "app.description":
    "Viqo Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Viqo Data logosu",
  ...
  "header.githubAria": "GitHub'da Viqo'a yıldız ver",
  "header.github": "GitHub",
  "header.tryViqo": "Viqo'u dene",
  ...
  "footer.homeAria": "Viqo ana sayfası",
  ...
  "home.topModelsDescription": "Viqo Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Viqo Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Viqo Data",
  "lab.description":
    "Viqo Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Viqo kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Viqo'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Viqo kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Viqo token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Viqo Data",
  "model.description":
    "{{model}} için Viqo Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Viqo Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Viqo Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Viqo Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Viqo Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Viqo Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Viqo Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Viqo Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Viqo Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Viqo Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Viqo Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Viqo Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Viqo Go token hacmine göre yakındaki modeller.",
