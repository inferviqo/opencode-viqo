import viqoWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/Inferviqo/viqo",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "viqo:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://inferviqo.com/">
            <strong>{i18n.t("header.tryViqo")}</strong>
          </a>
          <button
...
function ViqoMark() {
  return (
    <svg data-slot="viqo-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://inferviqo.com/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://inferviqo.com/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@inferviqo.com", label: i18n.t("footer.contact") },
    { href: "https://inferviqo.com/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/viqo", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://inferviqo.com" aria-label={i18n.t("footer.homeAria")}>
          <ViqoMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={viqoWordmarkDark} alt="Viqo" />
          <button
