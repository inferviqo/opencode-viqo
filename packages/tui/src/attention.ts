...
import defaultSoundPath from "@viqo-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@viqo-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@viqo-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@viqo-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@viqo-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@viqo-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "viqo"
const DEFAULT_PACK_ID = "viqo.default"
