...
import type { AssistantMessage, FilePart, UserMessage } from "@viqo-ai/sdk/v2"
...
import { VIQO_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useViqoKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.VIQO_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
