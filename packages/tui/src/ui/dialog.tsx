...
import { useBindings, useViqoModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useViqoModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.VIQO_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
