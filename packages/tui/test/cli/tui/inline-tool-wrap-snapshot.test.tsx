...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "VIQO.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/viqo/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/viqo (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/viqo/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/viqo/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const VIQO_DB|VIQO_DB|VIQO_DEV|Global\\.Path\\.data|data =" in packages/viqo/src (115 matches)',
  },
] as const
