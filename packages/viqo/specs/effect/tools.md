...
Practical reference for the current tool-migration state in `packages/viqo`.
...
Tool tests should use the existing Effect helpers in `packages/viqo/test/lib/effect.ts`:
