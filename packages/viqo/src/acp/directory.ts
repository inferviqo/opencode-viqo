...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@viqo/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@viqo/ACPDirectory") {}
