...
import { normalizePromptContent } from "@viqo-ai/tui/editor"
...
import { VIQO_BASE_MODE, useBindings } from "@viqo-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Viqo" } satisfies SlashOption,
    ]
