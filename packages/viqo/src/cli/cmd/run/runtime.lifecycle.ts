...
import { openEditor } from "@viqo-ai/tui/editor"
import { registerViqoKeymap } from "@viqo-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerViqoKeymap(keymap, renderer, input.tuiConfig)
