...
import { EventSequenceTable, EventTable } from "@viqo-ai/core/event/sql"
...
import { WorkspaceEvent } from "@viqo-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        VIQO_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        VIQO_WORKSPACE_ID: config.id,
        VIQO_EXPERIMENTAL_WORKSPACES: "true",
