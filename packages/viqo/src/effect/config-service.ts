 ...
 *   "@viqo/ServerAuthConfig",
 *   {
 *     password: Config.string("VIQO_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("VIQO_SERVER_USERNAME").pipe(Config.withDefault("viqo")),
 *   },
 * ) {}
 *
