...
export class Service extends Context.Service<Service, Interface>()("@viqo/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __VIQO_PHOTON_WASM_PATH?: string }).__VIQO_PHOTON_WASM_PATH =
