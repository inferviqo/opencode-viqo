import type { Hooks, PluginInput } from "@viqo-ai/plugin"
import type { Model } from "@viqo-ai/sdk/v2"
import { InstallationVersion } from "@viqo-ai/core/installation/version"
import { OauthCallbackPage } from "@viqo-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Viqo will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
