...
import { ProjectDirectoryTable, ProjectTable } from "@viqo-ai/core/project/sql"
import { ProjectDirectories } from "@viqo-ai/core/project/directories"
...
import { which } from "@viqo-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.VIQO_FAKE_VCS)
