...
import { makeApi } from "@viqo-ai/protocol/api"
import { LocationMiddleware } from "@viqo-ai/server/location"
import { SessionLocationMiddleware } from "@viqo-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("viqo-root")
...
export const InstanceHttpApi = HttpApi.make("viqo-instance")
...
export const ViqoHttpApi = HttpApi.make("viqo")
