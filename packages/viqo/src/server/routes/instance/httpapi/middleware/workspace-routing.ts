...
>()("@viqo/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@viqo/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.VIQO_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.VIQO_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-viqo-directory"] || process.cwd()
}
