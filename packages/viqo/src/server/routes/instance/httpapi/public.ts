...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for viqo serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(ViqoHttpApi)
...
export const PublicApi = ViqoHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "viqo",
    version: "1.0.0",
    description: "viqo api",
