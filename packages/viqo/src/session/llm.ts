...
import { llmClient } from "@viqo-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@viqo-ai/llm"
import { LLMClient } from "@viqo-ai/llm/route"
import type { LLMClientService } from "@viqo-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via viqo's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @viqo-ai/llm. It
