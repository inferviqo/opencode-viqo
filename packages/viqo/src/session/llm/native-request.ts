import type { JsonSchema, LLMRequest, ProviderMetadata } from "@viqo-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@viqo-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @viqo-ai/llm request objects from viqo's session/AI SDK-shaped data.
  return LLM.request({
