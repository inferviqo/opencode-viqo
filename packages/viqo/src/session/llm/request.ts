...
const USER_AGENT = `viqo/${InstallationVersion}`
...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const viqoProjectID = input.model.providerID.startsWith("viqo")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("viqo")
        ? {
            ...(viqoProjectID ? { "x-viqo-project": viqoProjectID } : {}),
            "x-viqo-session": input.sessionID,
            "x-viqo-request": input.user.id,
            "x-viqo-client": input.flags.client,
