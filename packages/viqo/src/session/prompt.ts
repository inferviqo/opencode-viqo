...
import { MAX_STEPS_PROMPT } from "@viqo-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@viqo-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/SessionPrompt") {}
