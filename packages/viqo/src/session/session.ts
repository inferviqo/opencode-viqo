...
import { locationServiceMapLayer } from "@viqo-ai/core/location-services"
...
import { PartTable, SessionTable } from "@viqo-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@viqo-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".viqo", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@viqo/Session") {}
