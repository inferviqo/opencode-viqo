...
import type * as SDK from "@viqo-ai/sdk/v2"
...
import { SessionShareTable } from "@viqo-ai/core/share/sql"
import { ProviderV2 } from "@viqo-ai/core/provider"
import { ModelV2 } from "@viqo-ai/core/model"
import { EventV2 } from "@viqo-ai/core/event"

const disabled = process.env["VIQO_DISABLE_SHARE"] === "true" || process.env["VIQO_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/ShareNext") {}
