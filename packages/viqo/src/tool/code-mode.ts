...
import { CodeMode, Tool as SandboxTool, toolError } from "@viqo-ai/codemode"
import { MCP } from "@/mcp"
...
export const Parameters = Schema.Struct({
  code: Schema.String.annotate({
    description: [
      ...
      "Inside CodeMode, `tools` contains only the MCP/CodeMode tools listed in this execute tool's description; top-level viqo tools like bash, read, or lsp are not available unless listed there.",
