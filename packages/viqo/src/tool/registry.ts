...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@viqo-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@viqo/ToolRegistry") {}
