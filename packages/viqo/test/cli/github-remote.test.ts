...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/viqo.git")).toEqual({ owner: "sst", repo: "viqo" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/viqo")).toEqual({ owner: "sst", repo: "viqo" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/viqo.git")).toEqual({ owner: "sst", repo: "viqo" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/viqo")).toEqual({ owner: "sst", repo: "viqo" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/viqo.git")).toEqual({ owner: "sst", repo: "viqo" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/viqo")).toEqual({ owner: "sst", repo: "viqo" })
})
