...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders VIQO_CALLER", () => {
    process.env["VIQO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode VIQO_CALLER", () => {
    process.env["VIQO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown VIQO_CALLER", () => {
    process.env["VIQO_CALLER"] = "unknown"
