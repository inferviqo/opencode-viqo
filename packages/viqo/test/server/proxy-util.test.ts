...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips viqo-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-viqo-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-viqo-directory")).toBeNull()
      expect(result.get("x-viqo-workspace")).toBeNull()
