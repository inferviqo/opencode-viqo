...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips viqo-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-viqo-directory"]).toBeUndefined()
      expect(forwarded["x-viqo-workspace"]).toBeUndefined()
