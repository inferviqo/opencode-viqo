...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في viqo.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في viqo مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.viqo/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/viqo/tools/`.
