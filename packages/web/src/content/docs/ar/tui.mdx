---
title: TUI
description: استخدام واجهة المستخدم TUI في Viqo.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Viqo واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Viqo إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Viqo في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Viqo. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Viqo. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `viqo.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Viqo بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `viqo.default`.
