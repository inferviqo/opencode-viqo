...
Možete dodati prilagođene komande kroz Viqo konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Viqo [config](/docs/config):
...
- Globalno: `~/.config/viqo/commands/`
- Po projektu: `.viqo/commands/`
...
Viqo uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
