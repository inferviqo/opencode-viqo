---
title: LSP serveri
description: Viqo se integriše sa vašim LSP serverima.
---

Viqo se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Viqo dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `VIQO_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i viqo otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj viqo konfiguraciji.
