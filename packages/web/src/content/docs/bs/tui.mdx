---
title: TUI
description: Korištenje korisničkog interfejsa Viqo terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Viqo pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Viqo pokreće TUI za trenutni direktorij.
...
Kada koristite Viqo TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Viqo. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Viqo. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `viqo.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Viqo čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `viqo.default`.
