---
title: LSP-servere
description: Viqo integreres med dine LSP-servere.
---

Viqo kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Viqo leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `VIQO_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og viqo åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din viqo-konfiguration.
