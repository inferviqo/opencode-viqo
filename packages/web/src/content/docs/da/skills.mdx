...
Agentferdigheter lar Viqo oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Viqo opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Viqo viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `viqo.json`:
