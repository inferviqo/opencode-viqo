...
Erstellen Sie `.viqo/commands/test.md`:

```md title=".viqo/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Viqo-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Viqo [config](/docs/config):

```json title="viqo.jsonc" {4-12}
{
...
- Global: `~/.config/viqo/commands/`
- Pro Projekt: `.viqo/commands/`

```markdown title="~/.config/viqo/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".viqo/commands/component.md"
---
...
```md title=".viqo/commands/create-file.md"
---
...
```md title=".viqo/commands/analyze-coverage.md"
---
...
```md title=".viqo/commands/review-changes.md"
---
...
```md title=".viqo/commands/review-component.md"
---
...
Viqo enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
