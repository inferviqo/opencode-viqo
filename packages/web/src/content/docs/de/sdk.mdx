---
title: SDK
description: Typsicherer JS-Client fuer den viqo-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das viqo JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und viqo programmatisch steuern.
...
`viqo.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn viqo bereits laeuft, kannst du nur einen Client erstellen und verbinden:
