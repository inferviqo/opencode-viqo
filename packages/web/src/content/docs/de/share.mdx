---
title: Teilen
description: Teile Viqo-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Viqo-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Viqo Folgendes:
...
Viqo hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Viqo den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`viqo.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du viqo in deiner Organisation einsetzt.
