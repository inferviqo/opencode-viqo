---
title: Zen
description: Kuratierte Modellliste direkt von Viqo.
---
...
Viqo Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Viqo-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Viqo. Du meldest dich bei Viqo Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Viqo zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Viqo funktionieren.
:::
...
Viqo Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Viqo Zen funktioniert wie jeder andere Provider in Viqo.

1. Du meldest dich bei **<a href={console}>Viqo Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Viqo Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Viqo-Konfiguration verwendet das Format `viqo/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `viqo/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf Viqo verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Viqo verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf Viqo verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Viqo verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Viqo verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Viqo Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Viqo auch jeden anderen Provider zu verwenden.
