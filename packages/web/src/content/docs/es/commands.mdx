...
Puede agregar comandos personalizados a través de la configuración Viqo o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Viqo [config](/docs/config):
...
viqo incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
