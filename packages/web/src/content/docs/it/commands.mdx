...
Puoi aggiungere comandi personalizzati tramite la config di Viqo o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Viqo:
...
- Globale: `~/.config/viqo/commands/`
- Per progetto: `.viqo/commands/`
...
viqo include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
