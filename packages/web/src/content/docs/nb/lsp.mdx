---
title: LSP-servere
description: viqo integreres med LSP-serverne dine.
---

Viqo kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Viqo kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `VIQO_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og viqo åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Viqo-konfigurasjonen.
