---
title: Deling
description: Del dine Viqo-samtaler.
---

Delingsfunksjonen i Viqo lar deg lage offentlige lenker til dine Viqo-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Viqo støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Viqo manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `viqo.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av viqo i organisasjonen din.
