...
Agentferdigheter lar Viqo oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
viqo søker etter disse stedene:

- Prosjektkonfigurasjon: `.viqo/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/viqo/skills/<name>/SKILL.md`
...
For prosjektlokale stier går viqo opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.viqo/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/viqo/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.viqo/skills/git-release/SKILL.md` slik:
...
viqo viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `viqo.json`:
...
**For innebygde agenter** (i `viqo.json`):
