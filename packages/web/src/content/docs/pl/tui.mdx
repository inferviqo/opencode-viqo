---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala viqo.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

viqo zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie viqo uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI viqo, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do viqo. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `viqo.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Viqo czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `viqo.default`.
