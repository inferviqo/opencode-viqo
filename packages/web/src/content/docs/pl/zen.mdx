---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Viqo.
---
...
Viqo Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Viqo.

Zen działa jak każdy inny dostawca w Viqo. Logujesz się do Viqo Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Viqo.
:::
...
Viqo Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Viqo Zen działa jak każdy inny dostawca w Viqo.

1. Logujesz się do **<a href={console}>Viqo Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Viqo Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Viqo używa formatu
`viqo/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`viqo/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w Viqo przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Viqo przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w Viqo przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Viqo przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Viqo przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Viqo także dowolnego innego dostawcy.
