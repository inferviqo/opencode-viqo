...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Viqo:
...
- ระดับผู้ใช้ (Global): `~/.config/viqo/commands/`
- ระดับโปรเจ็กต์: `.viqo/commands/`
...
Viqo มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
