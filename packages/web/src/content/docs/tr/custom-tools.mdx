---
title: Özel Araçlar
description: LLM'un viqo'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. viqo'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.viqo/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/viqo/tools/` içine yerleştirerek.
