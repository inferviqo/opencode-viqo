...
description: viqo dile özgü biçimlendiriciler kullanır.
---

viqo, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

viqo, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, viqo bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

viqo bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri viqo yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
