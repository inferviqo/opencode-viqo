---
title: Paylasim
description: viqo konusmalarini genel baglantilarla paylasin.
---

viqo'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda viqo:
...
viqo, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak viqo manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `viqo.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda viqo kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
