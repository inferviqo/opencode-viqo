...
Ajan becerileri, viqo'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
viqo su konumlari tarar:

- Proje konfigurasyonu: `.viqo/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/viqo/skills/<name>/SKILL.md`
...
Proje yerel yollarinda viqo, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.viqo/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/viqo/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.viqo/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
viqo, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`viqo.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`viqo.json` icinde):
