---
title: Zen
description: viqo tarafından sağlanan seçilmiş modeller listesi.
---
...
Viqo Zen, Viqo ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Viqo'daki diğer sağlayıcılar gibi çalışır. Viqo Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Viqo kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Viqo ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Viqo Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Viqo Zen, Viqo'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Viqo Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Viqo Zen'i seçin ve API anahtarınızı yapıştırın.
...
Viqo yapılandırmanızdaki [model id](/docs/config/#models) `viqo/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `viqo/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Viqo'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Viqo'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Viqo'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Viqo'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Viqo'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Viqo Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Viqo ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
