...
Generates UPCOMING_CHANGELOG.md by running the viqo changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for viqo run (default: low)
      --quiet            Suppress viqo command output unless it fails
