...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Inferviqo/viqo/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Inferviqo/viqo...\n")
...
console.log("Fetching npm all-time downloads for viqo-ai...\n")
const npmDownloads = await fetchNpmDownloads("viqo-ai")
